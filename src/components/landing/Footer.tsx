    ...
    <footer className="bg-[#111] text-white pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center space-y-8 mb-16">
          ...
          <p className="text-gray-400 max-w-md">The hardcore realm awaits its next legend. Join the Forsaken community and stake your claim today.</p>
          <Button
            size="lg"
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="space-y-2 text-center md:text-left">
            ...
            <p className="text-sm text-gray-500">© {new Date().getFullYear()} {SERVER_NAME}. All rights reserved.</p>
          </div>
          <div className="flex items-center gap-4">
            <a href={SOCIAL_LINKS.discord} className="p-3 bg-white/5 rounded-xl hover:bg-white/10 transition-colors">
              <MessageSquare className="w-6 h-6" />
            </a>
            <a href={SOCIAL_LINKS.twitter} className="p-3 bg-white/5 rounded-xl hover:bg-white/10 transition-colors">
