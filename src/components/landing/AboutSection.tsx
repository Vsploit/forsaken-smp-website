...
export function AboutSection() {
  return (
    <section id="about" className="py-20 bg-orange-50/30">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {ABOUT_DATA.features.map((feature, idx) => (
                  <div key={idx} className="flex items-start gap-3 p-4 bg-white border-2 border-black rounded-xl shadow-hard-sm">
                    <div className="flex-shrink-0 w-8 h-8 bg-orange-500 rounded-lg border-2 border-black flex items-center justify-center mt-0.5">
