            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {ABOUT_DATA.features.map((feature, idx) => (
                  <div key={idx} className="flex items-start gap-3 p-4 bg-orange-50/50 dark:bg-orange-900/5 border-2 border-foreground rounded-xl shadow-hard-sm">
                    <div className="flex-shrink-0 w-8 h-8 bg-orange-600 rounded-lg border-2 border-foreground flex items-center justify-center mt-0.5">
