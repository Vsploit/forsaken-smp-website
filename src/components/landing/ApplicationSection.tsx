            ...
            <form onSubmit={onSubmit} className="space-y-8">
              ...
              <div className="form-item">
                ...
                <Textarea
                  ...
                  onChange={handleChange}
                  className="border-4 border-foreground p-4 rounded-xl min-h-[100px] focus-visible:ring-orange-500 bg-background transition-all shadow-hard-sm"
                />
              ...
              <div className="flex flex-row items-start space-x-3 space-y-0 rounded-xl border-4 border-foreground p-6 bg-orange-50 dark:bg-orange-900/5 shadow-hard-sm hover:bg-orange-100/50 transition-colors cursor-pointer">
                <input
                  type="checkbox"
                  id="rules"
                  checked={formData.rulesAccepted}
                  onChange={handleCheck}
                  className="mt-1 border-4 border-foreground h-6 w-6 transition-all"
                />
