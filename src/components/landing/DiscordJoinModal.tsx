...
export function DiscordJoinModal({ children }: DiscordJoinModalProps) {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-md border-4 border-black shadow-hard p-6 bg-white">
        <DialogHeader className="space-y-4">
          ...
          <DialogTitle className="text-3xl font-black uppercase tracking-tight text-center">Join Our Discord</DialogTitle>
        ...
        <div className="space-y-6 pt-4">
          <div className="flex items-center space-x-2 bg-orange-50 p-2 border-2 border-black rounded-xl">
            <Input
              readOnly
              value={discordLink}
              className="border-none bg-transparent focus-visible:ring-0 font-mono text-sm h-10"
            />
            <Button 
              size="icon" 
          ...
          <Button 
            className="w-full bg-black text-white hover:bg-gray-800 h-12 font-bold rounded-xl" 
